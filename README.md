...
Личный каталог ссылок: REST API на Go + веб-интерфейс. Позволяет сохранять закладки с тегами, просматривать их, фильтровать по тегам и удалять. Данные сохраняются на диск и переживают перезапуск сервера.
